...
while(have_posts()){
  ...
  <div class="container container--narrow page-section">
    <div class="create-note">
        ...
        <span class="note-limit-message">Note limit reached: Delete an existing post and make room for new one.</span>
    </div>
    ...
    <ul class="min-list link-list" id="my-notes">
       <?php 
        ...
        while($userNotes->have_posts()){
            $userNotes->the_post(); ?>
            <li data-id = "<?php the_id(); ?>"> <!-- if you are gettin the values from the database into the html attributes then we have to wrap that with esc_attr() -->
